...
const ContactIcon = ({ size, style, isActive, fillInactive }) => (
  <svg
    style={style}
    height={size}
    width={size}
    ...
    fill={isActive ? "#ffffff" : fillInactive}
  >
    ...
    <g id="SVGRepo_iconCarrier">
      <path
        ...
        fill={isActive ? "#deebed" : fillInactive}
      ></path>
      <path
        ...
        fill={isActive ? "#ebfcff" : fillInactive}
      ></path>
      <path
        ...
        fill={isActive ? "#e0e6e6" : fillInactive}
      ></path>
    </g>
  </svg>
);
