...
const FeatherWhiteIcon = ({ size, style, isActive, fillInactive }) => (
  <svg
    style={style}
    fill={isActive ? "white" : fillInactive}
    height={size}
    width={size}
    version="1.1"
    id="Capa_1"
