...
const FeatherIcon = ({ size, color, style, isActive, fillInactive }) => (
  <svg
    style={style}
    height={size}
    width={size}
  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      <path
        fill={isActive ? "#e5f1ff" : fillInactive}
        // fill="#e5f1ff"
        d="M4.048 29.644c-.811-.558-1.541-4.073-.936-4.404c.738-.402.686.835 2.255 2.362c1.569 1.528 6.47.913 7.708 1.326c1.363.455-6.385 2.533-9.027.716z"
      ></path>
      <path
        fill={isActive ? "#f0f7ff" : fillInactive}
        // "#f0f7ff"
      ...
      <path
        fill={isActive ? "#e5f1ff" : fillInactive}
        // fill="#e5f1ff"
        d="M19.15 12.787c1.588.966 5.331 1.943 8.316 2.422c1.898-1.937 3.299-3.378 4.302-4.529c-2.259-.49-5.742-1.3-7.487-2.087l-.816-.403l-4.872 4.17l.557.427z"
      ></path>
      <path
        fill={isActive ? "#f0fffa" : fillInactive}
        // fill="#f0fffa"
      ...
      <path
        fill={isActive ? "#e5f1ff" : fillInactive}
        // fill="#e5f1ff"
        d="M35 1c-.369 0-.751-.003-1.138-.008c-3.915 1.874-7.509 4.194-10.772 6.73c-.68-.87-1.451-2.532-1.807-4.013a42.574 42.574 0 0 0-4.484 2.539c.309 1.911.852 4.377 1.455 5.589C6.827 22.441.638 34.605.553 34.776a.5.5 0 0 0 .895.448c.119-.238 12.144-23.883 33.659-33.72A7.693 7.693 0 0 0 35 1z"
      ></path>
    </g>
  </svg>
);
